        ...
        $('#dates').multiDatesPicker({
            ...
            onSelect: function (d, i) {
                ...
                if ($('#dates').multiDatesPicker('gotDate', d) === false) {
                    ...
                    $('.selected-dates:last').after("<tr id=\"date-" + d + "\" class=\"selected-dates dates-line\" valign=\"top\"><th scope=\"row\" class=\"dates-line-heading\">" + sdate.toLocaleDateString("de-DE", { month: "2-digit", day: "2-digit", year: "numeric" }) + "</th><td><input type=\"date\" size=\"6\" id=\"dates-" + d + "-date\" required name=\"dates[" + d + "][date]\" class=\"datum dates-line-date\" value=\"" + d + "\" readonly><input type=\"time\" class=\"startTime dates-line-time\" required step=\"60\" value=\"" + ('0' + sdate.getHours()).slice(-2) + ":" + ('0' + sdate.getMinutes()).slice(-2) + "\" min=\"00:00\" max=\"23:59\" name=\"dates[" + d + "][start]\" id=\"dates-"+d+"-start\"> &mdash; <nobr><input type=\"datetime-local\" size=\"6\" name=\"dates[" + d + "][end]\" id=\"dates-" + d + "-end\" class=\"datum nb-clrfix-input\" min=\"" + dateToHtmlIso(sdate) + "\" value=\"" + dateToHtmlIso(endDate) + "\" " + (defaultDuration == -1 ? "disabled" : "required") + "><input type=\"time\" disabled class=\"nb-clrfix-fix\"> Uhr</nobr> <div class=\"dates-line-break\">oder <input type=\"checkbox\" data-disables-id=\"dates-" + d + "-end\" name=\"dates[" + d + "][openEnd]\" class=\"openEnd\" " + (defaultDuration == -1 ? "checked" : "") + "> offenes Ende</div></td></tr>");
                    $("#dates-" + d + "-start").on("change", function() {
                        $("#dates-" + d + "-end").attr('min', $("#dates-" + d + "-date").val() + "T" + $("#dates-" + d + "-start").val());
                    });
